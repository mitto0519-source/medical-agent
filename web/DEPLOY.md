...
vercel env add NEXT_PUBLIC_SITE_URL production
  # 입력: https://medical-agent.vercel.app
```
...
```bash
# 공개 페이지
curl https://medical-agent.vercel.app/                  # 랜딩
curl https://medical-agent.vercel.app/llms.txt          # GEO
curl https://medical-agent.vercel.app/sitemap.xml       # 동적 sitemap
curl https://medical-agent.vercel.app/research/38542705 # 동적 paper
curl https://medical-agent.vercel.app/concept/C_adolescent

# 앱 (로그인 필요)
# https://medical-agent.vercel.app/app
```
...
huggingface.co/spaces/cave87/medical-agent  ← Streamlit (현 8501) + FastAPI (8000 후속)
  ↓ (SSE /chat)
medical-agent.vercel.app                     ← Next.js (web/) — 공개+앱 동시
